...
myportfolio.currentYear = new Date().getUTCFullYear(),
myportfolio.config = {    
    list: {
        columns: {
            names: {
                ...
                'je-yearReturn1CUR': 'JE-Return ' + (myportfolio.currentYear - 1),
                'je-yearReturn2CUR': 'JE-Return ' + (myportfolio.currentYear - 2),
                'je-yearReturn3CUR': 'JE-Return ' + (myportfolio.currentYear - 3),
                'je-yearReturn4CUR': 'JE-Return ' + (myportfolio.currentYear - 4),
            ...
            visibility: ['isin', 'ms-Name', 'je-ter', 'je-assetClass', 'ms-CategoryName'],
            typeIsNumber: ['ms-Yield_M12'],
            filterable: ['je-assetClass', 'je-bondType', 'ms-CategoryName', 'je-distributionPolicy', 'je-fundCurrency'],
            sortOrder: ['isin', 'name', 'je-description', 'je-ter', 'je-assetClass']
        }
    }
};
